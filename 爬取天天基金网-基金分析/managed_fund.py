...
def text_to_html():
    trigger_html_str = ''
    important_information[-2][-1] = 3.4830
    important_information[-1][-1] = 1.2221
    important_information[-2][-2] = float(float(float(important_information[-2][1]) - float(important_information[-2][-1])) / float(important_information[-2][-1]) * 100)
    important_information[-2][-2] = "{:.3}".format(important_information[-2][-2])
    important_information[-1][-2] = float(
        float(float(important_information[-1][1]) - float(important_information[-1][-1])) / float(important_information[-1][-1]) * 100)
    important_information[-1][-2] = "{:.3}".format(important_information[-1][-2])
    important_information.sort(key=lambda x:(x[2]),reverse=False)
